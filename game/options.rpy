...
define config.name = _("Multiversal Love Potion")
...
define config.main_menu_music = "Music/G/maintitle.ogg"
...
define config.save_directory = "BloodieyVariantLovePotion-1724031099"
